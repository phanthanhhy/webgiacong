    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            if (@Session["nvUser"] != null)
            {
                ...
                List<GCX_TienDoGiaCongXuong_ChiTiet> gcx_chiTiet2 = db.GCX_TienDoGiaCongXuong_ChiTiet.Where(x => listMaMay.Any(maMay => x.MaMayGC.Contains(maMay)) && x.CoGC == "TGC").ToList();
